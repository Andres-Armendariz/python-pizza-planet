...
from app.populate_db.client import generate_client_data
from app.populate_db.orderDetail import generate_order_details
from app.repositories.models import Size


def generate_orders(num_people):
    fake = Faker()
    orders = []
    error = None
...
def create_order(fake, client_data):
    ...
    details = generate_order_details()
